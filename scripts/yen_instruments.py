"""The newly sizeable yen instruments on the cost-charging walk-forward simulator.
...
select the history window. See docs/EDGE_FINDINGS.md section 96.
"""
...
GROUPS={"yen_new":["EURJPY","GBPJPY","CADJPY","J225","USDJPY"]}
...
async def main():
    ...
    try:
        ...
        await p.disconnect()
    print(f"\n===== NEWLY SIZEABLE YEN INSTRUMENTS at 2-ATR stop, with router-passed subset ({DAYS_FROM}-{DAYS_TO} d) =====")
