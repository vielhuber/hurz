...
_REGISTRY = {
    ...
    # Parallel analysis aliases of donchian_breakout with canonical wider
    # risk:reward targets. v3 remains resolvable for backtests but is blocked
    # from live evaluation and execution in autotrade.
