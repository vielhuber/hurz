...
class StrategyParameterTest(unittest.TestCase):
    def test_donchian_aliases_use_live_risk_reward(self) -> None:
    ...
    def test_backtest_cli_resolves_v3_live_risk_reward(self) -> None:
        argv = [
            "spot_backtest.py",
    ...
    def test_live_override_wins_over_cli_default(self) -> None:
        argv = [
            "spot_backtest.py",
            "--strategy", "donchian_breakout_v3",
            "--rr", "1.5",
